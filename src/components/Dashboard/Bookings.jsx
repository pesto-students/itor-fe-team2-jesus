...
export default function Bookings() {
  ...
  return (
    <Box sx={{ width: '100%' }} className='booking_wrapper'>
        <h1>Bookings</h1>
      <p>The session timings are following your local timezone 
Asia/Calcutta</p>
      ...
      <TabPanel value={value} index={0}>
       ...
       <img className='mentor_dash_img booking' src={mentor8} alt="mentor pic" />
       <div>
      ...
      <TabPanel value={value} index={1}>
        <p>You have no pending bookings - start sharing a conversation with a mentor.</p>
